...
import { deleteUserAvailability, validateNoUnhandledApplication } from "@/server/services/applicationService";
...
/**
 * Endpoint for deleting an availability from a users' profile.
 *
...
export async function POST(request: Request) {
  try {
    ...
    await deleteUserAvailability(userData.id, availabilityData.availabilityID, request);
